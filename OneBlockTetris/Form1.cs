...
{
    //Form class is being initialized
    public partial class Form1 : Form
    {
        ...
        string directory = System.IO.Directory.GetCurrentDirectory(); //needed for accessing the score and sound files at the end
        ...
        public Form1()
        {
            ...
            //m is a variable for the highest score
        ...
        private void TimerTickEvent(object sender, EventArgs e)
        {
            ...
            {
                timer.Stop();
                //a message is shown upon the end of the game
                ...
                if (quitOrContinue == DialogResult.Yes)
                {
                    ...
                    // all the values are reset if the user wants to play again
                    blocksFilled = new bool[40];
                    fallingPiece = -3;
                    timer.Start();
                    n = 0;
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            //right arrow key, pretty much the same settings as for the left key
        ...
        //these events are called if a particular menu button is pressed
        private void menuToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //a game is paused if you are in the menu
            timer.Stop();
        }
        ...
        private void restartToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //all the values are being reset for the new game
            blocksFilled = new bool[40];
            fallingPiece = -3;
            timer.Start();
            n = 0;
